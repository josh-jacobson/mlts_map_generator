...
class ScreeningsControllerTest < ActionController::TestCase
  ...
  test "should create screening" do
    assert_difference('Screening.count') do
      post :create, screening: { address: @screening.address, date_and_time: @screening.date_and_time, latitude: @screening.latitude, longitude: @screening.longitude }
    end
  ...
  test "should update screening" do
    patch :update, id: @screening, screening: { address: @screening.address, date_and_time: @screening.date_and_time, latitude: @screening.latitude, longitude: @screening.longitude }
    assert_redirected_to screening_path(assigns(:screening))
  end
